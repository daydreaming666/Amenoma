MaterialsNameCHS = {
    ...
    "空月祝福·新月": "BlessingOfTheWelkinMoonNewMoon",
    ...
    "枫木": "MapleWood",
    "魔偶机心": "MarionetteCore",
    "附有记忆的面具": "MaskOfMemories",
    "今昔剧画之鬼人": "MaskOfTheKijin",
    "今昔剧画之一角": "MaskOfTheOneHorned",
    "今昔剧画之虎啮": "MaskOfTheTigersBite",
    "今昔剧画之恶尉": "MaskOfTheWickedLieutenant",
    "无主的星尘": "MasterlessStardust",
    "无主的星辉": "MasterlessStarglitter",
    "松茸": "Matsutake",
    "花鳉": "Medaka",
    "漂亮的中结晶": "MediumPrettyCrystal",
    "牛奶": "Milk",
    "薄荷": "Mint",
    ...
    "霜噬结晶": "RimeWornCrystal",
    "霜噬碎屑": "RimeWornFragment",
    "北风之环": "RingOfBoreas",
    "锖假龙": "RustyKoi",
    "绯樱绣球": "SakuraBloom",
    "盐": "Salt",
...
MaterialsNameEN = {
    ...
    "Cabbage": "Cabbage",
    "Cake for Traveler": "CakeForTraveler",
