...
class GameInfo:
    ...
    def calculateCoordinates(self):
        ...
        self.art_rows = int(round((1270 * self.scale_ratio + self.h - 1440 * self.scale_ratio - self.first_art_y + self.art_gap_y) / (
                    self.art_height + self.art_gap_y)))
        self.incomplete_lastrow = ((1270 * self.scale_ratio + self.h - 1440 * self.scale_ratio - self.first_art_y + self.art_gap_y) / (
